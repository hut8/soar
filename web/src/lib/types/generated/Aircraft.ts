 ...
 */
export type Aircraft = { id: string, addressType: string, address: string, aircraftModel: string, registration: string | null, competitionNumber: string, tracked: boolean, identified: boolean, clubId: string | null, createdAt: string, updatedAt: string, fromOgnDdb: boolean, fromAdsbxDdb: boolean, frequencyMhz: number | null, pilotName: string | null, homeBaseAirportIdent: string | null, aircraftTypeOgn: AircraftType | null, lastFixAt: string | null, trackerDeviceType: string | null, icaoModelCode: string | null, countryCode: string | null, ownerOperator: string | null, 
/**
