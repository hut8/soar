 ...
 * Aircraft position
 */
latitude: number, longitude: number, altitudeMslFeet: number | null, altitudeAglFeet: number | null, 
/**
 * Flight information
 */
flightNumber: string | null, squawk: string | null, 
/**
 * Performance data
 */
groundSpeedKnots: number | null, trackDegrees: number | null, climbFpm: number | null, turnRateRot: number | null, 
/**
 ...
 * Associations
 */
flightId: string | null, aircraftId: string, 
/**
