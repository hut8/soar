<script lang="ts">
	...
	import { MapPin, Plane, Navigation, UserCheck, ExternalLink, Image } from '@lucide/svelte';
						...
						<div class="card p-4">
							...
							<div class="space-y-2 text-sm">
								...
								{#if plane.model?.builderCertification}
									<div class="border-surface-200-700-token border-b pb-2">
										<span class="text-surface-600-300-token font-medium">Airworthiness Class:</span>
