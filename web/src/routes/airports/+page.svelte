		...
		{#if !locationSearch}
			<div class="space-y-4">
				...
				<div class="flex justify-center">
					<button class="btn variant-filled-primary" on:click={searchAirports}>
						Search Airports
					</button>
				</div>
			</div>
				...
				{#each airports as airport}
					<div class="card p-6 space-y-4">
						<header class="card-header">
							...
							{#if airport.ident}
								<p class="text-sm font-mono text-primary-500">{airport.ident}</p>
							{/if}
						</header>
						...
						<footer class="card-footer">
							<div class="flex flex-wrap gap-2">
								{#if airport.type === 'small_airport'}
									<span class="badge variant-filled-secondary">Small Airport</span>
								{:else if airport.type === 'medium_airport'}
									<span class="badge variant-filled-primary">Medium Airport</span>
								{:else if airport.type === 'large_airport'}
									<span class="badge variant-filled-success">Large Airport</span>
								{:else if airport.type === 'heliport'}
									<span class="badge variant-filled-warning">Heliport</span>
								{:else if airport.type === 'seaplane_base'}
									<span class="badge variant-filled-tertiary">Seaplane Base</span>
								{:else if airport.type === 'closed'}
									<span class="badge variant-filled-error">Closed</span>
								{:else}
									<span class="badge variant-soft">Airport</span>
								{/if}
							</div>
						</footer>
					</div>
