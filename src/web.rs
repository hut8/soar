...
pub async fn start_web_server(interface: String, port: u16, pool: PgPool) -> Result<()> {
    ...
    let api_router = Router::new()
        ...
        .route("/airports/bounding-box", get(actions::get_airports_in_bounding_box))
        ...
        // Device routes
        .route("/device/{id}", get(actions::get_device_by_id))
        .route("/device/{id}/fixes", get(actions::get_device_fixes))
