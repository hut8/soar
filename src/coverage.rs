...
/// Aggregated coverage data per h3_index (grouped across receivers and dates)
#[derive(Debug, Clone)]
pub struct AggregatedCoverageH3 {
    pub h3_index: i64,
    pub resolution: i16,
    pub fix_count: i64,
    pub first_seen_at: DateTime<Utc>,
...
impl CoverageHexFeature {
    /// Convert aggregated coverage data to GeoJSON polygon feature
    pub fn from_aggregated_coverage(coverage: AggregatedCoverageH3) -> anyhow::Result<Self> {
        use h3o::CellIndex;
