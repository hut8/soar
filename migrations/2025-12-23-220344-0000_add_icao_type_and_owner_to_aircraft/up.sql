...
COMMENT ON COLUMN aircraft.icao_type_code IS 'ICAO aircraft type designator (e.g., C172, PA28, B737) from ADS-B Exchange';
COMMENT ON COLUMN aircraft.owner_operator IS 'Aircraft owner/operator name from ADS-B Exchange';
